...
def analyze_east_framework(text, process_map):
    ...
    | 2. 情報の構造性 | 情報は項目ごとに構造化され、視覚的にわかりやすく、時系列にそって配置されているか。情報の重複はないか。 |  |
...
| **Step3** 文書以外の改善ができないか、プロセス全体を見直してください。 | プロセス全体の見直しにつなげるため、この文書以外の改善アイデアも提示します。 |
""", unsafe_allow_html=True)
