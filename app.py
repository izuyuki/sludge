...
def analyze_webpage(content, url):
    ...
    さらに、改善後のウェブページ案を"すぐにコピペして使えるレベル"で、与えられたURLの情報を整理したものとして日本語で詳細に出力してください。
    ...
    【改善後のページ案】
    （ここに、与えられたページ内容をもとに、情報を整理し、見出し・本文・箇条書き・表などを適切に使い、すぐにコピペして使える日本語の完成度で出力してください。無駄な装飾や説明は不要です）
