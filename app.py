...
|---------|-------------------|-------------------|
| **Step1** | チラシなどのPDF文書（１ファイル）をアップロードしてください。 | 文書のターゲット、促したい目標行動、そこに至るプロセスを可視化します。 |
| **Step2** | 診断結果を踏まえて、チラシなどを実際に改善します。 | 提示される重要な改善ポイント５選は、すぐに取り組めます。<br>※改善文書の自動生成機能は、現在準備中です。 |
